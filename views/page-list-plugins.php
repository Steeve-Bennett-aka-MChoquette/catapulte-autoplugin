...
<div class="wrap">
	<h1>
		<?php esc_html_e( 'Autoplugins', 'catapulte-autoplugin' ); ?>
	...
	if ( $no_plugins ) {
		...
		<div class="catapulte-autoplugin-card">
			<h2><?php esc_html_e( 'You don\'t have any autoplugins yet.', 'catapulte-autoplugin' ); ?></h2>
			<p><?php esc_html_e( 'Autoplugins are regular plugins, but they are generated by AI. You can manage them just like any other plugin. They will be listed here for your convenience.', 'catapulte-autoplugin' ); ?></p>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=catapulte-autoplugin-generate' ) ); ?>" class="button button-primary button-hero"><?php esc_html_e( 'Generate New Plugin', 'catapulte-autoplugin' ); ?></a>
		</div>
		<?php
	} else {
